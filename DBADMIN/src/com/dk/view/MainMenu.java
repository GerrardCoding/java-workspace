...
public class MainMenu {
		...
		public void mainMenu() {
			...
			while(true) {
				...
				switch(menu) {
				case 1: mc.selectList(); break;     // Controll 패키지에 있는 클래스에 처리
				case 2: insertMember(); break;   // 현재 클래스에서 처리
				case 3: updateMember(); break;   // 현재 클래스에서 처리
				case 4: mc.deleteMember(inputMemberId()); break;   // Controll 패키지에 있는 클래스에 처리
				case 5: mc.selectById(inputMemberId()); break;     // Controll 패키지에 있는 클래스에 처리
